<?php
/**
* @version		$Id: emailasusername.php 2017-10-19 (version 5.39) $
* @package		Joomla 3.x Native version
* @copyright	Copyright (C) 2016 LunarHotel.co.uk. All rights reserved.
...
*/
/*
Updated template overrides for joomla 3.8.1

Fixes post login redirect not working when emailasusername is enabled.

Fixes deprecation warning in apollo.php

Updated Hikashop integration

This version:
Updated JoomShopping Integration
Added support for hg_login_module


updated hikashop integration
updated hikashop integration

updated vp onepagecheckout support

Updated reset password page so that it doesnt break the auto token filling when you click the link in the email recovery email

Updated support for Hikashop

Added support for superlogin pro and tested with Mijoshop.

updated bt-login template overrides

Fixed Virtuemart removing spaces from between first and lastnames when the name field is hidden
Updated support for membershiop pro (os_membership) 2.0.2 (again)
Updated support for membershiop pro (os_membership) 2.0.2
Virtuemart support: Warnings showing when middle/last/first name is disabled.
