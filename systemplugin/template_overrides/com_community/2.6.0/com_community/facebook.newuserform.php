...
<table width="100%">
	<tr>
	    ...
	    <td><input type="text" id="newname" class="inputbox" size="30" value="<?php echo $userInfo['name'];?>" onblur="joms.connect.checkRealname(this.value);"/><div id="error-newname" class="small" style="display: none;color: red;"></div>
		<input type="text" value="usrname" id="newusername" style="display:none;" size="30" onblur="joms.connect.checkUsername(this.value)"/>
		<div id="error-newusername" class="small" style="display: none;color: red;"></div>
		</td>
	</tr>
	<!-- <tr>
		<td valign="top"><label for="newusername"><?php echo JText::_('COM_COMMUNITY_USERNAME');?></label></td>
		<td><input type="text" value="dylanjh" id="newusername" class="inputbox required" size="30" onblur="joms.connect.checkUsername(this.value)"/><div id="error-newusername" class="small" style="display: none;color: red;"></div></td>
	</tr> -->
	<tr>
