...
<?php
OSMembershipHelper::validateForm();
switch($this->action) 
{
	case 'upgrade' :
...
<form method="post" action="<?php echo $actionUrl ; ?>" name="osm_login_form" id="osm_login_form" autocomplete="off" class="form form-horizontal">
	...
	<div class="control-group">
		<label class="control-label" for="username">
			<?php echo  JText::_('JGLOBAL_EMAIL') ?><span class="required">*</span>
		</label>
		<div class="controls">
...
?>			
<form method="post" name="os_form" id="os_form" action="<?php echo JRoute::_('index.php?option=com_osmembership&task=process_subscription&Itemid='.$this->Itemid, false, $this->config->use_https ? 1 : 0); ?>" enctype="multipart/form-data" autocomplete="off" class="form form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input value="" class="validate[required,<?php echo $minSize;?>] text-input osm_inputbox inputbox" type="password" name="password1" id="password1" autocomplete="off"/>
		</div>		
	</div>		
	<div class="control-group">
	...
	?>
		...
		<?php 
			if ($this->plan->recurring_subscription) 
			{
				...
				<?php
					...
					if ($this->config->enable_coupon || $trialTaxAmount > 0) 
					{
					?>
					<div class="control-group">
						<label class="control-label">
			...
			<?php
				...
				if ($this->config->enable_coupon || $this->fees['regular_tax_amount'] > 0) 
				{
				?>
					<div class="control-group">
						<label class="control-label">
			...
			<?php
				...
				if ($this->config->enable_coupon || $this->fees['tax_amount'] > 0) 
				{
				?>
				<div class="control-group">
					<label class="control-label">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="input-medium" name="coupon_code" id="coupon_code" value="<?php echo JRequest::getVar('coupon_code');?>" onchange="validateCoupon();" />
			...
			{
			?>
			<div class="control-group" id="payment_method_container" class="payment_information">				
		...
		?>			
		<div class="control-group" id="tr_card_number" <?php echo $style; ?> class="payment_information">
		...
		<div class="control-group" id="tr_exp_date" <?php echo $style; ?> class="payment_information">
			<label class="control-label">
		...
		<div class="control-group" id="tr_cvv_code" <?php echo $style; ?> class="payment_information">
			<label class="control-label">
		...
		?>
			<div class="control-group" id="tr_card_type" <?php echo $style; ?> class="payment_information">
				<label class="control-label">
		...
		?>
			<div class="control-group" id="tr_card_holder_name" <?php echo $style; ?> class="payment_information">
				<label class="control-label">
		...
		?>
		    <div class="control-group" id="tr_bank_rounting_number" <?php echo $style; ?> class="payment_information">
		    ...
		    <div class="control-group" id="tr_bank_account_number" <?php echo $style; ?> class="payment_information">
		    ...
		    <div class="control-group" id="tr_bank_account_type" <?php echo $style; ?> class="payment_information">
		    ...
		    <div class="control-group" id="tr_bank_name" <?php echo $style; ?> class="payment_information">
		    ...
		    <div class="control-group" id="tr_bank_account_holder" <?php echo $style; ?> class="payment_information">
		...
		?>
			<div class="control-group" id="tr_bank_list" <?php echo $style; ?> class="payment_information">
				<label class="control-label">
	...
	?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="validate[required] inputbox input-mini" value="" size="8" name="security_code" />
	...
	<script type="text/javascript">
		(function($){
			$(document).ready(function(){
				$("#os_form").validationEngine();				
				buildStateField('state', 'country', '<?php echo $selectedState; ?>');
			})
		})(jQuery);
		var planId = <?php echo $this->plan->id; ?>;
		var siteUrl = '<?php echo OSMembershipHelper::getSiteUrl();  ?>';
		var invaliEmailMsg = "<?php echo JText::_('OSM_INVALID_EMAIL_ENTERED'); ?>";		
		<?php
