		...
		<tr>
			...
			<table class="html-email" cellspacing="0" cellpadding="0" border="0" width="100%">
				...
				<td valign="top" width="100%">
				    Ciao , Grazie per esserti registrato. Ora è possibile accedere utilizzando l'indirizzo email e la password che hai scelto durante la registrazione.
				    <?php
				    echo $li;
				    echo vmText::_('JGLOBAL_EMAIL')  . ":" . $this->user->email . $li;
				    if ($this->password) {
