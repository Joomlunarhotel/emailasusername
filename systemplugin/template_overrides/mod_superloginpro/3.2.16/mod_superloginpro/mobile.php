...
?>
	...
	<?php if ($params->get('slp_style', 'mobile')) : ?>
    <button class="slp-mobile uk-button uk-button-primary uk-hidden-medium uk-hidden-large" data-uk-offcanvas="{target:'#slp-mobile'}"><i class="uk-icon-signin uk-icon-small"></i></button>
    <div id="slp-mobile" class="uk-offcanvas uk-hidden-medium uk-hidden-large">
	<div class="uk-offcanvas-bar uk-hidden-medium uk-hidden-large">
